...
const linkCategories = [
  {
    ...
    links: [
      ...
      // }
      {
        ...
        subtitle:
          "Currently offering a variety of private options in Oahu, online worldwide.",
      },
    ],
  },
  {
    ...
    links: [
      {
        ...
        subtitle:
          "Get FREE personalised recommendations on Natural Solutions with Essential Oils.",
      },
      {
      ...
      },
      {
        ...
        subtitle:
          "Purchase as as Wholesale Customer and get this healthy habits bundle 25% off!",
      },
    ],
  },
  {
    ...
    links: [
      {
        ...
        subtitle:
          "Got an Idea you wanna bring into Reality? Let's get some clarity here!",
      },
      {
        href:
    ...
    <Layout id="get-started-page" seo={seo}>
      <section>
        ...
        <SectionHeader
          ...
          subtitle={
            <span>
              Looking to get started with living a higher vibrational lifestyle?
              Check out these quick resources! Otherwise{" "}
              <Link href="/">Browse Around</Link> :)
            </span>
          }
        />
